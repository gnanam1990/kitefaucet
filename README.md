...
- **Nonce safety:** API drip transactions share one wallet client and an in-process pending-nonce queue, so concurrent requests cannot race the faucet wallet nonce.
